...
/**
 * CompositionLocal to provide and access the current `CoinRoutineColorsPalette`.
 * This allows for theming support by dynamically switching between light and dark color palettes.
 */
